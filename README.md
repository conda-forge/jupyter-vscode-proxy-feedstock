...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9010&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-vscode-proxy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-vscode-proxy` can be installed with:

```
conda install jupyter-vscode-proxy
```

It is possible to list all of the versions of `jupyter-vscode-proxy` available on your platform with:
